...
[pdf](/assets/course_material/cs780spring2023/lectures/lec_1_intro_to_NLP.pdf)

### Schedule

| Week 	 | Lecture 	 | Day 	 | Date 	 | Description                                	 | Assignment Due 	 | Slides                                                                                                     | Notebook                                                                                            |
|--------|-----------|-------|--------|----------------------------------------------|------------------|------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| 1    	 | 1       	 | Tu  	 | 1/24 	 | Introduction to NLP                        	 | 	                | <a href="/assets/course_material/cs780spring2023/lectures/lec_1_intro_to_NLP.pdf">PDF</a>                  |                                                                                                     |
| 1    	 | 2       	 | Th  	 | 1/26 	 | Basics of linguistics                      	 | 	                | <a href="/assets/course_material/cs780spring2023/lectures/lec_2_overview_of_linguistics.pdf">PDF</a>       |                                                                                                     |
| 2    	 | 3       	 | Tu  	 | 1/31 	 | Representing text numerically              	 | 	                | <a href="/assets/course_material/cs780spring2023/lectures/lec_3_numerically_representing_text.pdf">PDF</a> | [Drive link](https://colab.research.google.com/drive/1O8GKZdemXfP8HgeJtO36VnEMGQV4mnyI?usp=sharing) |
